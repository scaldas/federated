...
def run_federated(
    ...
    experiment_name: Optional[str] = 'federated_emnist',
    root_output_dir: Optional[str] = '/tmp/friendly_fl',
  ...
  Args:
    ...
    use_compression: Whether to use the compression flags for the experiment.
    dataset_cache_dir: Directory to cache the downloaded data. If None, 
  ...
  # Create dataset_cache_dir in case it doesn't exist. Otherwise, tff will default to
  # Keras's default cache directory anyways.
